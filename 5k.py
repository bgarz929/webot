...
# =========================
# HASH LOOP (masih Python, tapi ringan dibanding AES sebelumnya)
# =========================

def hash_loop(password):
    h = hashlib.sha512(password.encode()).digest()
    for _ in range(11512):
        h = hashlib.sha512(h).digest()
    return h.hex()

# =========================
# OPENSSL DECRYPT (NATIVE SPEED)
# =========================

def try_openssl(passphrase_hex):
