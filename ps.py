...
panel_words = [
    ["wand","tags","name","anon","meta","arql"],
    ["hash","perm","date","code","romb","bash"],
    ["sh38","sha3","s256","s384","mine","a384"],
    ["swap","exch","trad","fiat","sell","cash"],
    ["eire","nord","oslo","1984","scan","maps","LOKI","view"],
    ["tree","wood","root","seed","beam","node","data","list","9788","4432","size","peer"],
    ["aust","vest","pool","pull"],
