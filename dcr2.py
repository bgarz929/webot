...
def evpkdf(passphrase, salt, key_size, iv_size, iterations):
    derived = b""
    block = b""
...
key, iv = evpkdf(passphrase, salt, 32, 16, 10000)

cipher = AES.new(key, AES.MODE_CBC, iv)
pt = unpad(cipher.decrypt(ciphertext), 16)

# hex2a
wallet = bytes.fromhex(pt.decode()).decode()
