...
def try_decrypt(pwd):
    ...
    try:
        ...
        # Validasi sederhana: cari tanda file JSON Web Key
        if b'"kty"' in pt_unpad or b'RSA' in pt_unpad:
            return pt_unpad
    except Exception:
        return None
    return None
...
def main():
    ...
    print("Progress akan ditampilkan setiap 10.000 percobaan per proses.")
